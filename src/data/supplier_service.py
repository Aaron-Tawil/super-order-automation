...
EXCLUDED_EMAIL_DOMAINS = {
    ...
    # Israeli ISP emails
    "walla.co.il", "walla.com", "012.net.il", "netvision.net.il",
    "bezeqint.net", "zahav.net.il", "013.net", "smile.net.il",
    "013net.net", "barak.net.il", "internet-zahav.net",
...
class SupplierService:
    ...
    def __init__(self, firestore_client: firestore.Client = None):
        ...
        self._csv_cache_timestamp: Optional[datetime] = None
        # Track the meta timestamp we cached against
        self._cached_meta_timestamp: Optional[datetime] = None
    ...
    def _ensure_cache_loaded(self):
        ...
        for doc in docs:
            ...
            if email:
                ...
                self._email_cache[email] = supplier_code
    ...
    def get_supplier(self, supplier_code: str) -> Optional[dict]:
        """
    ...
    def get_supplier_instructions(self, supplier_code: str) -> Optional[str]:
        """
    ...
    def add_supplier(self, supplier_code: str, name: str, global_id: str = None,
    ...
    def update_supplier(self, supplier_code: str, name: str = None, 
                        global_id: str = None, email: str = None, 
                        phone: str = None, special_instructions: str = None) -> bool:
        """
    ...
    def _get_meta_timestamp(self) -> Optional[datetime]:
    ...
    def fuzzy_match_name(self, query: str) -> Optional[Tuple[str, float]]:
        """
        ...
        if len(matches) == 1:
            ...
            logger.warning(
                f"Fuzzy match ambiguous for '{query}': {len(matches)} candidates found"
            )
            return None
