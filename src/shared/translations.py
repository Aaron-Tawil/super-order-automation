...
HEBREW_STRINGS = {
    ...
    "auth_btn_login": "התחבר באמצעות Google",
    ...
    "auth_err_no_email": "שגיאה: לא ניתן למשוך כתובת דוא״ל מ-Google.",
    "auth_err_exchange": "שגיאה: נכשל ניסיון אימות מול שרתי Google.",
    "auth_err_invalid_state": "שגיאה: בקשת ההתחברות אינה תקינה או שפג תוקפה. נסה שוב.",
    "auth_err_config": "שגיאת תצורה: אימות Google לא הוגדר כראוי במערכת.",
